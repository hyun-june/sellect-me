            ...
            <div className="confirm_inner">
                ...
                <div>
                    <div className="inner_text">
                        <h6>계약 목적</h6>
                        <p>
                            본 계약은 셀렉터(클라이언트)가 셀럽(크리에이터)와
                            프로젝트를 진행함에 있어, 양측의 역할과 의무를
                            규정함을 목적으로 합니다.
                        </p>
                    </div>
                    <div className="inner_text">
                        <h6>금액 정보</h6>
                        <p>
                            계약금액: 1,000,000(촬영비) + 200,000(에스크로) +
                            120,000(부가세) = 1,320,000 (원)
                        </p>
                        <p>
                            계약금액지급방식: 셀렉트에스크로시스템 – 셀렉터가
                            계약 완료 신청을 할 시 셀럽에게 지급
                        </p>
                    </div>
                    <div className="inner_text">
                        <h6>취소 및 환불 규정</h6>
                    ...
                    <div className="inner_text">
                        ...
                        <p>
                            프로젝트 결과물에 대한 저작권 소유(셀렉터가 사용
                            권리를 갖되, 셀럽의 동의 없이 특정 용도로 사용 불가
                            등)
                        </p>
                        <p>
                            <strong>초상권</strong> : 셀럽의 초상권 사용에 대한
                            허가 범위 : 홈쇼핑 인서트 영상, 상세페이지
                        </p>
                        <p>
                            <strong>비밀유지</strong> : 셀럽과 셀렉터는 서로에게
                            제공되는 모든 정보의 기밀성을 유지해야 함
                        </p>
                    </div>
                </div>
